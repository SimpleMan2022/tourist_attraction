      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 p-4">
          <div class="mb-4">
            ...
            <small class="text-muted fw-semibold">Silahkan isi data dirimu</small>
          </div>
          ...
          <form action="" method="POST">
            ...
            <div class="mb-3">
              ...
              <input autofocus required id="fullname" type="fullname" class="form-control rounded" placeholder="example@gmail.com" name="fullname">
            </div>
            <div class="mb-3">
            ...
            <p class="fw-semibold">Sudah Punya Akun? <a href="login.php">Masuk</a></p>
